...
import { convertContinuedStringToDate, convertToDate } from "../utils/convertToDateFormat";
...
// # METHOD GET Request
// # /api/paymentVoucher
router.get("/e_payment_voucher_integrate", async (req: Request, res: Response) => {
	...
	const HEADER_FILENAMES = process.env.EPAYMENT_VOUCHER_HEADER_FILENAME.split(", ");
